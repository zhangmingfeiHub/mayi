...
public class ServiceLocator extends org.apache.axis.client.Service implements functions.rfc.sap.document.sap_com.sap03.Service {
    ...
    public functions.rfc.sap.document.sap_com.sap03.ZMM_MATERIAL_DATA_PortType getbinding() throws javax.xml.rpc.ServiceException {
    ...
    public functions.rfc.sap.document.sap_com.sap03.ZMM_MATERIAL_DATA_PortType getbinding(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            functions.rfc.sap.document.sap_com.sap03.BindingStub _stub = new functions.rfc.sap.document.sap_com.sap03.BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (functions.rfc.sap.document.sap_com.sap03.ZMM_MATERIAL_DATA_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                functions.rfc.sap.document.sap_com.sap03.BindingStub _stub = new functions.rfc.sap.document.sap_com.sap03.BindingStub(new java.net.URL(binding_address), this);
                _stub.setPortName(getbindingWSDDServiceName());
                return _stub;
            }
        }
