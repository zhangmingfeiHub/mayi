...
import functions.rfc.sap.document.sap_com_1.holders.TABLE_OF_ZMM_MATERIAL_DATAHolder;

public class ZMM_MATERIAL_DATAProxy implements functions.rfc.sap.document.sap_com_1.ZMM_MATERIAL_DATA_PortType {
  private String _endpoint = null;
  private functions.rfc.sap.document.sap_com_1.ZMM_MATERIAL_DATA_PortType zMM_MATERIAL_DATA = null;
  ...
  private void _initZMM_MATERIAL_DATAProxy() {
    try {
      zMM_MATERIAL_DATA = (new functions.rfc.sap.document.sap_com_1.ServiceLocator()).getbinding();
  ...
  public functions.rfc.sap.document.sap_com_1.ZMM_MATERIAL_DATA_PortType getZMM_MATERIAL_DATA() {
    if (zMM_MATERIAL_DATA == null)
      _initZMM_MATERIAL_DATAProxy();
