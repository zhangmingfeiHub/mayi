...
public class ServiceLocator extends org.apache.axis.client.Service implements functions.rfc.sap.document.sap_com_1.Service {
...
//    private java.lang.String binding_address = "http://rssapeccdev.chinaredstar.com:8000/sap/bc/srt/rfc/sap/zmm_material_data/280/service/binding";
    private java.lang.String binding_address = "http://172.16.3.7:8000/sap/bc/srt/rfc/sap/zmm_material_data/280/service/binding";
    ...
    public functions.rfc.sap.document.sap_com_1.ZMM_MATERIAL_DATA_PortType getbinding() throws javax.xml.rpc.ServiceException {
    ...
    public functions.rfc.sap.document.sap_com_1.ZMM_MATERIAL_DATA_PortType getbinding(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            functions.rfc.sap.document.sap_com_1.BindingStub _stub = new functions.rfc.sap.document.sap_com_1.BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (functions.rfc.sap.document.sap_com_1.ZMM_MATERIAL_DATA_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                functions.rfc.sap.document.sap_com_1.BindingStub _stub = new functions.rfc.sap.document.sap_com_1.BindingStub(new java.net.URL(binding_address), this);
                _stub.setPortName(getbindingWSDDServiceName());
                return _stub;
            }
        }
